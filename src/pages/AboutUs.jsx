...
export default function AboutUs() {
  ...
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen">
      {/* Page Header */}
      <div className="pt-24 pb-20 bg-blue-900 text-center relative overflow-hidden">
        <div 
      ...
      <section id="founder" className="bg-slate-50 py-12 sm:py-16 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl transition-all duration-500">
            <div className="h-1.5 w-full bg-blue-600" />
            <div className="grid lg:grid-cols-[320px_1fr] gap-0">
              <div className="relative flex flex-col items-center justify-start gap-5 px-6 py-8 lg:py-10 bg-[#223056]">
                <div className="absolute -top-10 -left-10 w-40 h-40 rounded-full bg-white/5 pointer-events-none" />
                
                <div className="relative z-10 mt-2">
                  <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-full p-1 bg-gradient-to-tr from-blue-900 via-orange-500 to-orange-400 shadow-xl">
                    <div className="w-full h-full rounded-full overflow-hidden bg-slate-800 border-4 border-slate-900">
                      <img src="/images/founder.jpg" alt="Santhosh — Founder, Gurukula Computer" className="w-full h-full object-cover object-top" loading="lazy" onError={(e) => { e.target.style.display = "none"; e.target.nextSibling.style.display = "flex"; }} />
                      <div className="w-full h-full hidden items-center justify-center bg-gradient-to-br from-blue-700 to-slate-900"><span className="text-5xl font-black text-white">S</span></div>
                    </div>
                  </div>
                  <div className="absolute -bottom-1 right-2 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-green-500 border-4 border-slate-900 flex items-center justify-center shadow-lg"><svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg></div>
                </div>
                
                <div className="relative z-10 text-center mt-2">
                  <h3 className="text-2xl sm:text-3xl font-black text-white">Santhosh</h3>
                  <p className="text-orange-500 font-bold text-xs sm:text-sm mt-1">Founder &amp; Director</p>
                  <p className="text-blue-300 text-[10px] sm:text-xs mt-0.5">Gurukula Computer, Belthangady</p>
                </div>
                ...
                <div className="relative z-10 w-full grid grid-cols-3 gap-2 mt-4">
                  {[{ val: "1000+", lab: "Students" }, { val: "2", lab: "Locations" }, { val: "30+", lab: "Courses" }].map((s) => (
                    <div key={s.lab} className="rounded-xl bg-white/10 border border-white/5 py-2.5 text-center">
              ...
              <div className="flex flex-col justify-start px-5 sm:px-8 py-8 lg:py-10 gap-6">
                <div>
                  <div className="inline-flex items-center gap-1.5 bg-blue-50 text-blue-700 text-[10px] sm:text-xs font-black px-3 py-1.5 rounded-full uppercase tracking-widest mb-4"><span className="text-sm">🎓</span> ABOUT ME</div>
                  <p className="text-slate-600 text-sm leading-relaxed">I'm <span className="font-black text-slate-900">Santhosh</span>, founder of <span className="font-bold text-blue-700">ICON – National Board of Computer Education</span> in Ujire and <span className="font-bold text-blue-700">Gurukula Computer</span> in Belthangady. Hailing from Dharmasthala, Karnataka, I began as a Computer Trainer with 2 years of hands-on experience before launching ICON at age <span className="font-black text-orange-500">23</span>.</p>
                </div>
                
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    { icon: "🏆", color: "bg-orange-50/50 border-orange-200/60", titleColor: "text-orange-800", title: "TOP 3 IN KARNATAKA", desc: "Ranked among Karnataka's Top 3 Computer Training Institutes by NBCE" },
                    { icon: "🎓", color: "bg-blue-50/60 border-blue-200/60", titleColor: "text-blue-800", title: "1,000+ STUDENTS TRAINED", desc: "Across two locations — Ujire and Belthangady" },
                    { icon: "💡", color: "bg-green-50/60 border-green-200/60", titleColor: "text-green-800", title: "30+ JOB-READY COURSES", desc: "AI Tools, Graphic Design, Tally, GST and beyond" },
                    { icon: null, color: "bg-orange-50/50 border-orange-200/60", titleColor: "text-orange-800", title: "WORLD'S FIRST AI CARD", desc: "Exclusive AI Foundation, 50+ Tools, Power BI, Tableau, internships & scholarships" },
                  ].map((item) => (
                    <div key={item.title} className={`flex items-start gap-3 rounded-xl border ${item.color} p-4`}>
                ...
                <div className="relative overflow-hidden rounded-xl px-5 py-4 bg-blue-50 mt-2">
                  <p className="text-[11px] font-black text-blue-700 uppercase tracking-widest mb-2">MY MISSION</p>
                  <p className="text-sm text-slate-600 leading-relaxed">"Equip every student with essential digital skills for success, making top-tier education accessible to all."</p>
                </div>
              </div>
            </div>
          </div>
